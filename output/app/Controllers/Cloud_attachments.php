...
class Cloud_attachments extends BaseController
{
    protected $roles;
    protected $table;
    protected $pfield;
    ...
    public function __construct()
    {
        ...
        $this->sub                     = 'cloud attachments';

        $this->data['table']           = $this->table           = PREFIX . 'eclaims_cloud_attachments';
        $this->data['pfield']          = $this->pfield          = 'cloudAttachmentID';
        $this->data['controller_page'] = $this->controller_page = site_url('cloud attachments');
    ...
    private function get_conditions()
    {
        ...
        $condition_fields = array(
            array(
                'variable'      => 'cloud attachments',
                'field'         => $this->table . '.cloud attachments',
                'default_value' => '',
                'operator'      => 'like_after',
                'title'         => 'Cloudattachments',
                'width'         => '100',
                'excel_width'   => '50',
                'align'         => 'left',
                'class'         => 'wx-100'
    ...
    public function save()
    {
        ...
        */
        ...
        if ($this->roles['create']) {
            ...
            // check duplicate
            if ($checker->check_duplicate('cloud attachments', $fields['cloud attachments'], $this->table)) {
    ...
    public function update()
    {
        ...
        */
        ...
        if ($this->roles['edit']) {
            ...
            // check duplicate
            if ($checker->check_duplicate_edit('cloud attachments', $fields['cloud attachments'], $this->table, $this->pfield, $id)) {
                $res['status']  = $status = 409;
                $res['title']   = 'Saving data';
                $res['message'] = 'Duplicate record found';
                $res['data']    = array();
