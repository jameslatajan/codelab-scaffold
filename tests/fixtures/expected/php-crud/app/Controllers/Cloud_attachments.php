...
class Cloud_attachments extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->data['table']           = $this->table           = PREFIX . 'cloud_attachments';
        $this->data['pfield']          = $this->pfield          = 'id';
        $this->data['controller_page'] = $this->controller_page = site_url('cloud_attachments');
    ...
    public function save()
    {
        ...
        */
        ...
        if ($this->roles['create']) {
            ...
            // check duplicate
            if ($checker->check_duplicate('name', $fields['name'], $this->table)) {
    ...
    public function update()
    {
        ...
        */
        ...
        if ($this->roles['edit']) {
            ...
            // check duplicate
            if ($checker->check_duplicate_edit('name', $fields['name'], $this->table, $this->pfield, $id)) {
                $res['status']  = $status = 409;
                $res['title']   = 'Saving data';
                $res['message'] = 'Duplicate record found';
                $res['data']    = array();
