            ...
            <div class="card mb-2">
                ...
                <div class="card-body p-0">
                    <table class="table table-sm mb-0 align-middle">
                        <tr>
                            <td class="text-end bg-light wx-100">Name <small class="text-danger">*</small></td>
                            <td>
                                <textarea name="name" id="" class="form-control form-control-sm wx-400" title="Name" required></textarea>
                            </td>
                        </tr>
                    </table>
                </div>
